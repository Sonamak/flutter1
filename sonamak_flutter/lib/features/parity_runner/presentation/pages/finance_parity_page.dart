...
class FinanceParityPage extends StatefulWidget { const FinanceParityPage({super.key}); @override State<FinanceParityPage> createState() => _FinanceParityPageState(); }

class _FinanceParityPageState extends State<FinanceParityPage> {
  ...
  EndpointSpec(method: 'GET', path: '/dashboard/refund-payments'),
  EndpointSpec(method: 'GET', path: '/examination/invoice'),
  EndpointSpec(method: 'POST', path: '/examination/update-added-payments'),
  EndpointSpec(method: 'GET', path: '/financial_transaction/all-data'),
  EndpointSpec(method: 'GET', path: '/financial_transaction/all-purchases'),
  EndpointSpec(method: 'GET', path: '/financial_transaction/branches'),
  EndpointSpec(method: 'POST', path: '/financial_transaction/custody'),
  EndpointSpec(method: 'POST', path: '/financial_transaction/edit-invoice'),
  EndpointSpec(method: 'GET', path: '/financial_transaction/excel-download'),
  EndpointSpec(method: 'GET', path: '/financial_transaction/filter'),
  EndpointSpec(method: 'GET', path: '/financial_transaction/financial-pdf'),
  EndpointSpec(method: 'GET', path: '/financial_transaction/invoice-data'),
  EndpointSpec(method: 'GET', path: '/financial_transaction/purchases/excel-download'),
  EndpointSpec(method: 'GET', path: '/financial_transaction/purchases/filter'),
  ...
  EndpointSpec(method: 'POST', path: '/dentist/create-invoice'),
  EndpointSpec(method: 'POST', path: '/dentist/delete-invoice/\${id}'),
  EndpointSpec(method: 'POST', path: '/dentist/edit-invoice'),
  EndpointSpec(method: 'GET', path: '/dentist/get-invoice'),
  ...
  EndpointSpec(method: 'GET', path: '/scan-payment'),
  EndpointSpec(method: 'POST', path: '/scan-payment'),
  EndpointSpec(method: 'GET', path: '/scan-payment/claims'),
  EndpointSpec(method: 'GET', path: '/scan-payment/statistics'),
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: const Text('Finance — Parity Runner')),
      body: Padding(
