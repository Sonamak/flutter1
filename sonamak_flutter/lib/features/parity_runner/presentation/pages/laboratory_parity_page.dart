...
class LaboratoryParityPage extends StatefulWidget { const LaboratoryParityPage({super.key}); @override State<LaboratoryParityPage> createState() => _LaboratoryParityPageState(); }

class _LaboratoryParityPageState extends State<LaboratoryParityPage> {
  ...
  EndpointSpec(method: 'POST', path: '/tumorAdv/store-laboratory'),
  ];
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: const Text('Laboratory — Parity Runner')),
      body: Padding(
