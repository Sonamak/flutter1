...
class DashboardParityPage extends StatefulWidget { const DashboardParityPage({super.key}); @override State<DashboardParityPage> createState() => _DashboardParityPageState(); }

class _DashboardParityPageState extends State<DashboardParityPage> {
  ...
  EndpointSpec(method: 'POST', path: '/dashboard/pay'),
  EndpointSpec(method: 'POST', path: '/dashboard/payment-clear'),
  EndpointSpec(method: 'GET', path: '/dashboard/payments'),
  EndpointSpec(method: 'GET', path: '/dashboard/queue'),
  EndpointSpec(method: 'POST', path: '/dashboard/queue/line'),
  EndpointSpec(method: 'POST', path: '/dashboard/queue/manual'),
  EndpointSpec(method: 'POST', path: '/dashboard/queue/update'),
  EndpointSpec(method: 'GET', path: '/dashboard/refund-payments'),
  EndpointSpec(method: 'POST', path: '/dashboard/update-reservation-info'),
  EndpointSpec(method: 'POST', path: '/dashboard/vitals/create'),
  ];
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: const Text('Dashboard — Parity Runner')),
      body: Padding(
