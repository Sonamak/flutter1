...
class PatientsParityPage extends StatefulWidget { const PatientsParityPage({super.key}); @override State<PatientsParityPage> createState() => _PatientsParityPageState(); }

class _PatientsParityPageState extends State<PatientsParityPage> {
  ...
  EndpointSpec(method: 'GET', path: '/examination/patient-examinations'),
  EndpointSpec(method: 'GET', path: '/patients/absent-excel-download'),
  EndpointSpec(method: 'POST', path: '/patients/add-tags'),
  EndpointSpec(method: 'GET', path: '/patients/all-patients'),
  EndpointSpec(method: 'POST', path: '/patients/create'),
  EndpointSpec(method: 'GET', path: '/patients/debts'),
  EndpointSpec(method: 'POST', path: '/patients/delete-image'),
  EndpointSpec(method: 'POST', path: '/patients/delete/\${id}'),
  EndpointSpec(method: 'GET', path: '/patients/examinations/\${id}'),
  EndpointSpec(method: 'GET', path: '/patients/excel-download'),
  EndpointSpec(method: 'GET', path: '/patients/filter'),
  EndpointSpec(method: 'POST', path: '/patients/history'),
  EndpointSpec(method: 'GET', path: '/patients/profile'),
  EndpointSpec(method: 'POST', path: '/patients/save-information'),
  EndpointSpec(method: 'POST', path: '/patients/update'),
  EndpointSpec(method: 'POST', path: '/patients/upload-image'),
  EndpointSpec(method: 'POST', path: '/medical_rep/insert'),
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: const Text('Patients & Examination — Parity Runner')),
      body: Padding(
