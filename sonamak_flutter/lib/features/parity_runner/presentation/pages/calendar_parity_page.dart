...
class CalendarParityPage extends StatefulWidget { const CalendarParityPage({super.key}); @override State<CalendarParityPage> createState() => _CalendarParityPageState(); }

class _CalendarParityPageState extends State<CalendarParityPage> {
  ...
  EndpointSpec(method: 'POST', path: '/calendar/add-appointment'),
  EndpointSpec(method: 'POST', path: '/calendar/close-days'),
  EndpointSpec(method: 'GET', path: '/calendar/data'),
  EndpointSpec(method: 'POST', path: '/calendar/delete-appointment/\${id}'),
  EndpointSpec(method: 'GET', path: '/calendar/doctors/\${event}'),
  EndpointSpec(method: 'POST', path: '/calendar/drag'),
  EndpointSpec(method: 'GET', path: '/calendar/event/\${id}'),
  EndpointSpec(method: 'GET', path: '/calendar/get-patient'),
  EndpointSpec(method: 'POST', path: '/calendar/resize'),
  EndpointSpec(method: 'GET', path: '/calendar/rooms-filter/\${event}'),
  EndpointSpec(method: 'POST', path: '/calendar/update-booking-note'),
  EndpointSpec(method: 'GET', path: '/schedules/appointments'),
  EndpointSpec(method: 'POST', path: '/schedules/confirm'),
  EndpointSpec(method: 'GET', path: '/schedules/excel-download'),
  EndpointSpec(method: 'GET', path: '/schedules/excel-online'),
  ];
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: const Text('Calendar & Booking — Parity Runner')),
      body: Padding(
