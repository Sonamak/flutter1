...
class ClinicRoomsBatch3ParityPage extends StatefulWidget { const ClinicRoomsBatch3ParityPage({super.key}); @override State<ClinicRoomsBatch3ParityPage> createState() => _ClinicRoomsBatch3ParityPageState(); }

class _ClinicRoomsBatch3ParityPageState extends State<ClinicRoomsBatch3ParityPage> {
  ...
  EndpointSpec(method: 'GET', path: '/rooms'),
  EndpointSpec(method: 'POST', path: '/rooms/insert'),
  ];
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: const Text('Clinic Rooms — Parity Runner')),
      body: Padding(
