...
class TumorsBatch3ParityPage extends StatefulWidget { const TumorsBatch3ParityPage({super.key}); @override State<TumorsBatch3ParityPage> createState() => _TumorsBatch3ParityPageState(); }

class _TumorsBatch3ParityPageState extends State<TumorsBatch3ParityPage> {
  ...
  EndpointSpec(method: 'GET', path: '/pricing-code/all'),
  EndpointSpec(method: 'GET', path: '/protocol-pricing'),
  EndpointSpec(method: 'GET', path: '/protocol-pricing/\${id}'),
  EndpointSpec(method: 'POST', path: '/protocol-pricing/delete/\${id}'),
  EndpointSpec(method: 'POST', path: '/protocol-pricing/insert'),
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: const Text('Oncology — Tumors — Parity Runner')),
      body: Padding(
