...
class ReferralsBatch3ParityPage extends StatefulWidget { const ReferralsBatch3ParityPage({super.key}); @override State<ReferralsBatch3ParityPage> createState() => _ReferralsBatch3ParityPageState(); }

class _ReferralsBatch3ParityPageState extends State<ReferralsBatch3ParityPage> {
  ...
  EndpointSpec(method: 'POST', path: '/examination/referral'),
  EndpointSpec(method: 'GET', path: '/referral/all-referrals'),
  EndpointSpec(method: 'GET', path: '/referral/referrals_count'),
  EndpointSpec(method: 'GET', path: '/referral/destination'),
  EndpointSpec(method: 'POST', path: '/referral/destination'),
  EndpointSpec(method: 'GET', path: '/referral/external'),
  EndpointSpec(method: 'POST', path: '/referral/external'),
  EndpointSpec(method: 'GET', path: '/referral/template'),
  EndpointSpec(method: 'POST', path: '/referral/template'),
  ];
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: const Text('Referrals — Parity Runner')),
      body: Padding(
