...
class AgreementsBatch3ParityPage extends StatefulWidget { const AgreementsBatch3ParityPage({super.key}); @override State<AgreementsBatch3ParityPage> createState() => _AgreementsBatch3ParityPageState(); }

class _AgreementsBatch3ParityPageState extends State<AgreementsBatch3ParityPage> {
  ...
  EndpointSpec(method: 'GET', path: '/insurances/social-excel-download'),
  EndpointSpec(method: 'POST', path: '/platforms/claims'),
  EndpointSpec(method: 'POST', path: '/platforms/claims-generate'),
  EndpointSpec(method: 'POST', path: '/platforms/claims-pay'),
  EndpointSpec(method: 'GET', path: '/platforms/filter'),
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: const Text('Agreements/Social — Parity Runner')),
      body: Padding(
