...
class DentistBatch3ParityPage extends StatefulWidget { const DentistBatch3ParityPage({super.key}); @override State<DentistBatch3ParityPage> createState() => _DentistBatch3ParityPageState(); }

class _DentistBatch3ParityPageState extends State<DentistBatch3ParityPage> {
  ...
  EndpointSpec(method: 'GET', path: '/dentist/all-composites'),
  EndpointSpec(method: 'GET', path: '/dentist/all-dentistry-categories'),
  EndpointSpec(method: 'GET', path: '/dentist/all-dentistry-procedures'),
  EndpointSpec(method: 'POST', path: '/dentist/chart-procedures'),
  EndpointSpec(method: 'POST', path: '/dentist/create-invoice'),
  EndpointSpec(method: 'POST', path: '/dentist/create-order'),
  EndpointSpec(method: 'GET', path: '/dentist/default-lab'),
  EndpointSpec(method: 'POST', path: '/dentist/delete-canal/\${id}'),
  EndpointSpec(method: 'POST', path: '/dentist/delete-diagnose'),
  EndpointSpec(method: 'POST', path: '/dentist/delete-examination-image'),
  EndpointSpec(method: 'POST', path: '/dentist/delete-invoice/\${id}'),
  EndpointSpec(method: 'POST', path: '/dentist/delete-note/\${id}'),
  EndpointSpec(method: 'POST', path: '/dentist/delete-order/\${id}'),
  EndpointSpec(method: 'POST', path: '/dentist/delete-procedure'),
  EndpointSpec(method: 'POST', path: '/dentist/delete-scan-image'),
  EndpointSpec(method: 'POST', path: '/dentist/edit-invoice'),
  EndpointSpec(method: 'GET', path: '/dentist/get-invoice'),
  EndpointSpec(method: 'GET', path: '/dentist/get-prescription'),
  EndpointSpec(method: 'POST', path: '/dentist/insert-dentistry-category'),
  EndpointSpec(method: 'POST', path: '/dentist/insert-dentistry-procedure'),
  EndpointSpec(method: 'POST', path: '/dentist/insert-diagnose'),
  EndpointSpec(method: 'POST', path: '/dentist/insert-note'),
  EndpointSpec(method: 'POST', path: '/dentist/insert-procedure'),
  EndpointSpec(method: 'POST', path: '/dentist/is-child'),
  EndpointSpec(method: 'POST', path: '/dentist/is-permanent'),
  EndpointSpec(method: 'POST', path: '/dentist/save-voice-note'),
  EndpointSpec(method: 'POST', path: '/dentist/store'),
  EndpointSpec(method: 'GET', path: '/dentist/teeth-data'),
  EndpointSpec(method: 'GET', path: '/dentist/teeth-lab'),
  EndpointSpec(method: 'POST', path: '/dentist/update-canal'),
  EndpointSpec(method: 'POST', path: '/dentist/update-filling'),
  EndpointSpec(method: 'POST', path: '/dentist/update-quantity'),
  EndpointSpec(method: 'POST', path: '/dentist/update-status'),
  EndpointSpec(method: 'POST', path: '/dentist/upsert-composite'),
  ];
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: const Text('Dentist — Parity Runner')),
      body: Padding(
