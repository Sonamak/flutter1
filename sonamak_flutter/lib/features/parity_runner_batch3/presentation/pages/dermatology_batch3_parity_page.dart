...
class DermatologyBatch3ParityPage extends StatefulWidget { const DermatologyBatch3ParityPage({super.key}); @override State<DermatologyBatch3ParityPage> createState() => _DermatologyBatch3ParityPageState(); }

class _DermatologyBatch3ParityPageState extends State<DermatologyBatch3ParityPage> {
  ...
  EndpointSpec(method: 'POST', path: '/dermatology/add-device'),
  EndpointSpec(method: 'GET', path: '/dermatology/device-types'),
  EndpointSpec(method: 'GET', path: '/dermatology/get-data'),
  EndpointSpec(method: 'POST', path: '/dermatology/post-data'),
  EndpointSpec(method: 'GET', path: '/dermatology/visit-info'),
  ];
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: const Text('Dermatology — Parity Runner')),
      body: Padding(
