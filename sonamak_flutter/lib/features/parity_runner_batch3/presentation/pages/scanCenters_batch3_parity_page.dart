...
class ScanCentersBatch3ParityPage extends StatefulWidget { const ScanCentersBatch3ParityPage({super.key}); @override State<ScanCentersBatch3ParityPage> createState() => _ScanCentersBatch3ParityPageState(); }

class _ScanCentersBatch3ParityPageState extends State<ScanCentersBatch3ParityPage> {
  ...
  EndpointSpec(method: 'POST', path: '/scans/insert'),
  EndpointSpec(method: 'GET', path: '/scan-center'),
  EndpointSpec(method: 'GET', path: '/scan-center/scans'),
  EndpointSpec(method: 'POST', path: '/scan-center/scans/delete/\${id}'),
  EndpointSpec(method: 'POST', path: '/scan-center/scans/store'),
  EndpointSpec(method: 'POST', path: '/scan-center/store'),
  EndpointSpec(method: 'POST', path: '/scan-claims/activation'),
  EndpointSpec(method: 'GET', path: '/scan-claims/data'),
  EndpointSpec(method: 'POST', path: '/scan-claims/edit'),
  EndpointSpec(method: 'POST', path: '/scan-claims/pay-off'),
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: const Text('Scan Centers — Parity Runner')),
      body: Padding(
