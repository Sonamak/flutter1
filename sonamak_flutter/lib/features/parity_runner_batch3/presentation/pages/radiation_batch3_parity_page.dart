...
class RadiationBatch3ParityPage extends StatefulWidget { const RadiationBatch3ParityPage({super.key}); @override State<RadiationBatch3ParityPage> createState() => _RadiationBatch3ParityPageState(); }

class _RadiationBatch3ParityPageState extends State<RadiationBatch3ParityPage> {
  ...
  EndpointSpec(method: 'GET', path: '/radiation'),
  EndpointSpec(method: 'GET', path: '/radiation/claims'),
  EndpointSpec(method: 'POST', path: '/radiation/claims/generate'),
  EndpointSpec(method: 'POST', path: '/radiation/claims/pay'),
  EndpointSpec(method: 'POST', path: '/radiation/delete/\${id}'),
  EndpointSpec(method: 'POST', path: '/radiation/insert'),
  EndpointSpec(method: 'GET', path: '/radiation/payments/\${id}'),
  EndpointSpec(method: 'POST', path: '/radiation/payments/disburse'),
  EndpointSpec(method: 'GET', path: '/radiation/profile/\${id}'),
  ];
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: const Text('Oncology — Radiation — Parity Runner')),
      body: Padding(
