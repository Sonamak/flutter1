...
class AppointmentsBatch3ParityPage extends StatefulWidget { const AppointmentsBatch3ParityPage({super.key}); @override State<AppointmentsBatch3ParityPage> createState() => _AppointmentsBatch3ParityPageState(); }

class _AppointmentsBatch3ParityPageState extends State<AppointmentsBatch3ParityPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: const Text('Appointment Requests — Parity Runner')),
      body: Padding(
