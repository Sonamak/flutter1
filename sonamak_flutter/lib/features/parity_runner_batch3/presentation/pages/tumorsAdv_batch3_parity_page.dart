...
class TumorsAdvBatch3ParityPage extends StatefulWidget { const TumorsAdvBatch3ParityPage({super.key}); @override State<TumorsAdvBatch3ParityPage> createState() => _TumorsAdvBatch3ParityPageState(); }

class _TumorsAdvBatch3ParityPageState extends State<TumorsAdvBatch3ParityPage> {
  ...
  EndpointSpec(method: 'GET', path: '/tumor/cycle'),
  EndpointSpec(method: 'POST', path: '/tumor/end-cycle'),
  EndpointSpec(method: 'GET', path: '/tumor/examination-history'),
  EndpointSpec(method: 'GET', path: '/tumor/follow-up-note'),
  EndpointSpec(method: 'GET', path: '/tumor/get-procedures'),
  EndpointSpec(method: 'GET', path: '/tumor/get-tumors'),
  EndpointSpec(method: 'GET', path: '/tumor/images'),
  EndpointSpec(method: 'GET', path: '/tumor/lab'),
  EndpointSpec(method: 'GET', path: '/tumor/lab-requests'),
  EndpointSpec(method: 'GET', path: '/tumor/lab-requests/filter'),
  EndpointSpec(method: 'GET', path: '/tumor/protocol'),
  EndpointSpec(method: 'GET', path: '/tumor/protocol-history'),
  EndpointSpec(method: 'GET', path: '/tumor/protocol-steps'),
  EndpointSpec(method: 'POST', path: '/tumor/protocol/type/delete/\${id}'),
  EndpointSpec(method: 'POST', path: '/tumor/protocol/type/insert'),
  EndpointSpec(method: 'GET', path: '/tumor/protocol/type/medical'),
  EndpointSpec(method: 'POST', path: '/tumor/save-procedures'),
  EndpointSpec(method: 'POST', path: '/tumor/store'),
  EndpointSpec(method: 'POST', path: '/tumor/store-follow-up-note'),
  EndpointSpec(method: 'POST', path: '/tumor/store-images'),
  EndpointSpec(method: 'POST', path: '/tumor/store-laboratory'),
  EndpointSpec(method: 'POST', path: '/tumor/store-protocol'),
  EndpointSpec(method: 'GET', path: '/tumor/types-of-cancer'),
  EndpointSpec(method: 'POST', path: '/tumor/types-of-cancer/insert'),
  EndpointSpec(method: 'POST', path: '/tumor/update'),
  EndpointSpec(method: 'POST', path: '/tumor/update-cycle'),
  EndpointSpec(method: 'POST', path: '/tumor/update-followup'),
  EndpointSpec(method: 'POST', path: '/tumor/update-protocol'),
  EndpointSpec(method: 'GET', path: '/tumor/visit-info'),
  EndpointSpec(method: 'GET', path: '/tumor/vitals'),
  EndpointSpec(method: 'GET', path: '/tumor/vitals/filter'),
  EndpointSpec(method: 'GET', path: '/protocol/step'),
  EndpointSpec(method: 'GET', path: '/tumorAdv/cycle'),
  EndpointSpec(method: 'POST', path: '/tumorAdv/end-cycle'),
  EndpointSpec(method: 'GET', path: '/tumorAdv/examination-history'),
  EndpointSpec(method: 'GET', path: '/tumorAdv/follow-up-note'),
  EndpointSpec(method: 'GET', path: '/tumorAdv/get-procedures'),
  EndpointSpec(method: 'GET', path: '/tumorAdv/get-tumors'),
  EndpointSpec(method: 'GET', path: '/tumorAdv/images'),
  EndpointSpec(method: 'GET', path: '/tumorAdv/lab'),
  ];
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: const Text('Oncology — TumorsAdv — Parity Runner')),
      body: Padding(
