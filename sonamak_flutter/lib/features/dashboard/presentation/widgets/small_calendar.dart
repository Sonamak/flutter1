  ...
  Widget build(BuildContext context) {
    ...
    return Column(
      ...
      children: [
        Row(
          children: [
            Text(DateFormat('MMMM yyyy').format(anchor), style: theme.textTheme.titleSmall?.copyWith(fontWeight: FontWeight.w600)),
          ],
        ),
          ...
          itemBuilder: (_, i) {
            ...
            return Container(
              ...
              decoration: BoxDecoration(
                color: isToday ? theme.colorScheme.primary.withValues(alpha: 0.12) : theme.colorScheme.surface,
                borderRadius: BorderRadius.circular(8),
                border: Border.all(color: theme.dividerColor),
              ),
              child: Text('${d.day}', style: theme.textTheme.bodySmall),
            );
          },
        ),
      ],
